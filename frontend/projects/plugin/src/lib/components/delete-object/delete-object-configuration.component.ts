...
@Component({
  standalone: false,
    selector: 'valtimo-delete-object-configuration',
    templateUrl: './delete-object-configuration.component.html',
})
export class DeleteObjectConfigurationComponent
    ...
    private handleValid(formValue: DeleteObjectConfig): void {
        const valid = !!(formValue.objectManagementConfigurationId && formValue.objectUrl);
